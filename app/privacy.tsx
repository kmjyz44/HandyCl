  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content} data-testid="privacy-screen">
        ...
        <Text style={styles.p}>
          We share information with: (a) other users as needed to facilitate a booking (e.g., Provider sees Client's name & address after acceptance); (b) payment processors (Finix and other supported payment providers); (c) SMS/email service providers acting only as our processors to deliver messages you request (Infobip and Resend); (d) law enforcement when legally required; (e) service providers acting on our behalf under confidentiality obligations. We do <Text style={styles.bold}>not</Text> sell your personal information to third parties.{'\n\n'}
          <Text style={styles.bold}>SMS/Mobile data:</Text> No mobile information, phone numbers, or SMS opt-in / consent data will be shared, sold, rented, leased, or otherwise transferred to third parties or affiliates for marketing or promotional purposes. SMS opt-in and consent are never shared with third parties under any circumstances. Phone numbers are disclosed only to our SMS provider (Infobip) solely to deliver the SMS verification codes you requested, and only to the extent necessary to send those messages.
        </Text>

        <Text style={styles.h2}>4. Communications & TCPA Consent</Text>
        <Text style={styles.p}>
          By providing your phone number and checking the SMS consent box, you agree: <Text style={styles.bold}>"I agree to receive SMS messages from Ono-Fix regarding phone verification, booking confirmations, appointment reminders, technician updates, and other service-related notifications. Message frequency varies. Msg & data rates may apply. Reply STOP to opt out. Reply HELP for help."</Text>{'\n\n'}
          SMS messages collected through this verification process are used only to send SMS verification codes needed to verify your phone number. We do not send promotional or marketing SMS without separate consent. Standard message and data rates apply, and message frequency varies. You may opt out at any time by replying STOP, or reply HELP for assistance. Email communications can be unsubscribed via the link in any email or by emailing <Text style={styles.link}>Nexus.ss.llc@gmail.com</Text>.{'\n\n'}
          Your SMS opt-in and consent are used solely to send you the messages described above and are never shared, sold, rented, or transferred to any third party or affiliate.
        </Text>

  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content} data-testid="privacy-screen">
        ...
        <Text style={styles.p}>
          We share information with: (a) other users as needed to facilitate a booking (e.g., Provider sees Client's name & address after acceptance); (b) payment processors (Finix and other supported payment providers); (c) SMS/email service providers acting only as our processors to deliver messages you request (Plivo and Resend); (d) law enforcement when legally required; (e) service providers acting on our behalf under confidentiality obligations. We do <Text style={styles.bold}>not</Text> sell your personal information to third parties.{'\n\n'}
          <Text style={styles.bold}>SMS/Mobile data:</Text> No mobile information, phone numbers, or SMS opt-in / consent data will be shared, sold, rented, leased, or otherwise transferred to third parties or affiliates for marketing or promotional purposes. SMS opt-in and consent are never shared with third parties under any circumstances. Phone numbers are disclosed only to our SMS provider (Plivo) solely to deliver the SMS verification codes you requested, and only to the extent necessary to send those messages.
        </Text>

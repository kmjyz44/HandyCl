    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content} data-testid="privacy-screen">
        ...
        <Text style={styles.p}>
          ...
          <Text style={styles.bold}>SMS/Mobile data:</Text> No mobile information, phone numbers, or SMS opt-in / consent data will be shared, sold, rented, leased, or otherwise transferred to third parties or affiliates for marketing or promotional purposes. SMS opt-in and consent are never shared with third parties under any circumstances. Phone numbers are disclosed only to our SMS provider (Twilio) solely to deliver the verification and service messages you requested, and only to the extent necessary to send those messages.
        </Text>
        ...
        <Text style={styles.p}>
          ...
          SMS messages are sent only for account verification and service-related notifications requested by the user. We do not send promotional or marketing SMS without separate consent. Standard message and data rates apply, and message frequency varies. You may opt out at any time by replying STOP, or reply HELP for assistance. Email communications can be unsubscribed via the link in any email or by emailing <Text style={styles.link}>Nexus.ss.llc@gmail.com</Text>.{'\n\n'}

...
const s = StyleSheet.create({
  ...
  aiStepText: { fontSize: 10, color: '#374151', fontWeight: '600', textAlign: 'center' },
  aiTray: { marginBottom: 10 },
  aiThumbWrap: { position: 'relative' },
  aiThumb: { width: 56, height: 56, borderRadius: 10, backgroundColor: '#e5e7eb' },
  ...
  aiThumbAdd: { width: 56, height: 56, borderRadius: 10, borderWidth: 1.5, borderColor: '#bfdbfe', borderStyle: 'dashed', alignItems: 'center', justifyContent: 'center', backgroundColor: '#eff6ff' },
  aiBtnRow: { flexDirection: 'row', gap: 10 },
  aiPrimaryBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, backgroundColor: '#2563eb', borderRadius: 12, paddingVertical: 10 },
  aiPrimaryBtnText: { color: '#fff', fontWeight: '700', fontSize: 14 },
  aiGhostBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, backgroundColor: '#eff6ff', borderRadius: 12, paddingVertical: 10, paddingHorizontal: 16, borderWidth: 1, borderColor: '#bfdbfe' },
  aiGhostBtnText: { color: '#2563eb', fontWeight: '700', fontSize: 13 },
  aiAnalyzeBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, backgroundColor: '#7c3aed', borderRadius: 12, paddingVertical: 11, marginTop: 8 },
  aiAnalyzeBtnText: { color: '#fff', fontWeight: '700', fontSize: 14 },
  aiHint: { fontSize: 10, color: '#9ca3af', textAlign: 'center', marginTop: 6 },

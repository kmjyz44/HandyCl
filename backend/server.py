...
# ─────────────────────────────────────────────────────────────────────────────
PROVIDER_AGREEMENT_VERSION = "1.1"
...
PROVIDER_AGREEMENT_FULL_TEXT = (
    "ONO-FIX SERVICE PROVIDER AGREEMENT (Version 1.1, effective June 1, 2026, last updated June 15, 2026)\n"
    ...
    "48. CHARGEBACK RESPONSIBILITY, SET-OFF & FUND RETENTION. (48.1) The Service Provider accepts full "
    "financial responsibility for all payment chargebacks, credit card disputes, unauthorized "
    "transactions, or ACH reversals initiated by Clients relating to services offered or billed through "
    "the Platform. (48.2) If a Client initiates a chargeback, refund request, or payment reversal, or if "
    "Finix Payments, Inc. (or any successor payment processor) debits funds from Ono-Fix or Nexus "
    "Security Solutions LLC corresponding to the Service Provider's transaction, Ono-Fix reserves the "
    "immediate right to: deduct the full chargeback amount plus applicable administrative dispute fees "
    "($30.00+ per occurrence) from the Service Provider's pending or future payouts; debit the Service "
    "Provider's designated bank account via ACH for any outstanding negative balance; and withhold "
    "payouts or impose a temporary hold (Rolling Reserve) on the Service Provider's account funds for up "
    "to 120 calendar days to cover potential chargebacks or dispute exposures. (48.3) The Service "
    "Provider agrees to maintain and promptly supply clear proof of service completion (signed work "
    "completion receipts, before-and-after photographic evidence, timestamped location logs, and written "
    "client approvals) within 48 hours of a dispute notice.\n"
    "49. INDEPENDENT CONTRACTOR STATUS & NON-PARTY ROLE. (49.1) The Service Provider acts solely as an "
    "independent contractor using its own tools, skills, and judgment; Ono-Fix is not an employer, joint "
    "venturer, partner, or agent. (49.2) Ono-Fix is strictly not a party to any contract or transaction "
    "between a Client and the Service Provider and assumes no responsibility or liability for the "
    "quality, safety, legality, timeliness, or adequacy of services; any personal injury, property loss, "
    "or material damage caused directly or indirectly by the Service Provider; or any misrepresentation, "
    "breach, or failure to complete requested work. Nothing excludes liability that cannot lawfully be "
    "excluded.\n"
    "50. ACCOUNT SUSPENSION & TERMINATION (ADDENDUM). Ono-Fix reserves the right, at its sole and "
    "absolute discretion, to suspend, limit, restrict, or permanently terminate the Service Provider's "
    "account and access at any time, with or without prior notice, subject to protections required by "
    "law, including for excessive chargeback rates or fraud risk, abusive or harmful conduct toward "
    "Clients, other providers, or Platform staff, or failure to supply required verification "
    "documentation (KYC/AML checks).\n"
    "51. 24-HOUR ADVANCE CHARGE LIMIT. The Service Provider is strictly prohibited from collecting "
    "payment or authorizing credit card charges more than twenty-four (24) hours prior to the actual "
    "physical commencement or delivery of the requested services, unless explicitly authorized in "
    "advance under a separate written agreement approved by Ono-Fix and its processing partners.\n"
    "52. ACKNOWLEDGMENT. Before accepting Jobs, the Service Provider has had the opportunity to review "
    ...
    "53. ELECTRONIC ACCEPTANCE. By checking the acceptance boxes and creating a provider account, the "
